...
AT_N_WS: '@' -> pushMode(Entity), type(ENTITY);
AT_P_WS: Hidden '@' -> pushMode(Entity), type(ENTITY);
AT_S_WS: '@' Hidden;
...
I_AT_N_WS: AT_N_WS -> pushMode(Entity), type(ENTITY);
I_AT_P_WS: AT_P_WS -> pushMode(Entity), type(ENTITY);
